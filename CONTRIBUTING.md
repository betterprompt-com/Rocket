## How to contribute to Betterprompt Rocket:
...
* It's important to note that the Betterprompt Rocket project primarily targets JavaScript 2015 (ES6) for maximum compatibility and broad support. Therefore, contributions in this area should adhere to the ES6 standard.
...
* The project maintains its target of JavaScript 2015 (ES6) for core compatibility. While personal hydration scripts and individual projects may utilize any ECMA script standard of your choice, contributions to the Betterprompt Rocket project itself should aim for ES6 as the minimum supported standard.
